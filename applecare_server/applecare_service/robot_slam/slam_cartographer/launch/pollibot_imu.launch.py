...
def generate_launch_description():
    ...
    configuration_basename = LaunchConfiguration(
        'configuration_basename', default='pollibot_imu_2d.lua'
    )
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            default_value='pollibot_imu_2d.lua',
    ...
    # RViz Node
    rviz_config_dir = os.path.join(pkg_pollibot_slam_cartographer, 'rviz', 'cartographer_imu.rviz')
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
