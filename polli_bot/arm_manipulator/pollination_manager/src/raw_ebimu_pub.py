...
'''
**REMEMBER!!! FOR THE MANIPULATOR'S IMU SENSOR, ONLY THE ROLL, PITCH, YAW VALUES ARE ACTIAVTED VIA THE EBTERMINAL (WINDOWS PROGRAM)
IF YOU NEED THE RAW 9DOF VALUES, CALIBRATE THE SENSOR USING THE EBTERMINAL 

Also, When the message "Permission denied: /dev/ttyx" appears, 
...
class EbimuPublisher(Node):
	...
	def __init__(self):
		super().__init__('raw_ebimu_publisher')
		qos_profile = QoSProfile(depth=10)
		qos_profile.reliability = ReliabilityPolicy.BEST_EFFORT
		self.publisher = self.create_publisher(String, 'raw_imu', qos_profile)
		# timer_period = 0.0005
		timer_period = 0.05
